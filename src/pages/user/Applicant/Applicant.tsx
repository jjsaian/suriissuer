...
const signUpSubComponent = (
    <>
      <h1 className='title'>Create wallet account</h1>
...
const logInSubComponent = (
    <>
      ...
      <p>Please log in with your wallet credentials.</p>
      <ApplicantLogin/>
    </>
)
...
const ApplicantLoginPage: React.FC = (): React.ReactElement => {
    ...
    return (
        <div className='page-form page-form--slim'>
            ...
            { showSignUp ? <small>Already have a wallet account?<a href='#' onClick={() => setShowSignUp(false)}> Log in here </a></small>: <small>Don't have a wallet account?<a href='#' onClick={() => setShowSignUp(true)}> Sign up here! </a></small>}
        </div>
    )
}
